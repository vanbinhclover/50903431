	if(cardBackgroundArray.length==0)cardBackgroundArray.push('images/solitaire/card_bg1.gif');
	...
	function finishCard()
	{
		...
		alert("Congratulations! - you did it.\nThank you for trying this game at Tre Today");
	}
	...
	function initSolitaire()
	{
		...
		for(var no=0;no<cardTypes.length;no++){
			...
			for(var no2=1;no2<=13;no2++){
				...
				imageArray[no][no2].src = 'images/solitaire/bg_' + cardTypes[no] + no2 + '.gif';
